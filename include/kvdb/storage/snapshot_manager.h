#ifndef KVDB_SNAPSHOT_MANAGER_H
#define KVDB_SNAPSHOT_MANAGER_H
...
struct SnapshotConfig {
    ...
    size_t wal_size_threshold = 1024 * 1024;   // WAL文件大小阈值（字节）
    size_t operation_count_threshold = 10000;  // 操作数量阈值
...
class SnapshotManager {
  ...
  private:
    ...
    size_t operations_since_snapshot_ = 0;
