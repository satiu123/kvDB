#ifndef KVDB_SNAPSHOT_H
#define KVDB_SNAPSHOT_H
 ...
 */
constexpr uint32_t SNAPSHOT_MAGIC = 0x4B564442;  // "KVDB"
...
class Snapshot {
  public:
     ...
     * @return 是否成功
     */
    bool create(const std::unordered_map<std::string, std::string>& data, uint64_t wal_offset = 0);
     ...
     * @return 是否成功
     */
    bool restore(std::unordered_map<std::string, std::string>& data, uint64_t& wal_offset);
